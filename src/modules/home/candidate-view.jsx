...
const CandidateView = () => {
  ...
  const handleYes = () => handlePrerequisite(4);
  const handleNo = () => handlePrerequisite(5);
  const submitPrerequisiteStatus = async (prerequisiteStatus) => {
                  ...
                  <Tooltip
                    ...
                    title={
                      <Box sx={{ ...statusBoxstyle }}>
                        ...
                        <Typography variant='body2' sx={{ ...statusstyle }}>
                          <strong>Verified Manually:</strong> The data has been manually verified
