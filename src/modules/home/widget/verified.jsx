...
import { toVerified } from 'shared/constants/constants';
...
const Verified = ({ fitToContaner, wizdata, dayRangePayLoad }) => {
    ...
    const greenFabStyle = {
        bgcolor: theme.palette.green1.light,
        color: theme.palette.common.white,
        "&:hover": {
            bgcolor: theme.palette.green1.main,
    ...
    return (
        ...
        >
            <>
                <Typography color={varifiedColor} variant="h4" fontWeight="600" mt="-20px">
                    {wizValue}
                </Typography>
