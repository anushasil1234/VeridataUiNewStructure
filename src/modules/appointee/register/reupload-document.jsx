...
import { congratulationDialogContentTitle, epfoPassbookFileTypeAlias, epfoServiceHistoryFileTypeAlias, imgAndPdfMaxSize, otherFileTypeAlias, previousButton, registrationSuccessDialogContentText, reUploadsubmitConfirmationMsg, tenthCertificateFileTypeAlias, toDashboard } from 'shared/constants/constants'
...
const ReuploadDocument = () => {
    ...
    const handlePostFileReupload = async () => {
        ...
        if (response) {
            ...
            openInfoModel(registrationSuccessContent, () => navigateTo(toDashboard, { state: { status: 'Submited' } }));
        }
