...
import { aadharVerifySuccessMsg, aadharVerifyFailedMsg, emptyAadharMsg, emptyShareCodeMsg } from "shared/constants/constants";
...
const AadhaarVerification = ({
    ...
    const handleConfirmFetchAadhaar = () => {
        ...
        handleFetchAadhaar();  // Call Aadhaar fetch function
    };
...
/*************  ✨ Windsurf Command ⭐  *************/
    /**
     * Toggles the visibility of the share code input field
     * and updates the icon displayed in the input field.
     */
/*******  75b23dca-8d43-4e53-a7fe-1b0969098e48  *******/
    ...
    return (
        <>
            ...
            <>
                {/* Radio Group for Aadhaar Verification Method */}
                <Grid item xs={12}>
                    <Typography
                        sx={{ ...headingType1, lineHeight: "2.4375em", marginLeft: "34px" }}
                    >
                    ...
                    >
                        ...
                        {AADHARVERIFICATION_BY === "Thirdparty" && (
                            <>
                                <Button
                                    ...
                                    disabled={isAadhaarVarified}
                                    variant="contained"
                                    onClick={handleOpenModal} // Open modal instead of direct fetch
                                    endIcon={<Autorenew />}
                                >
                        ...
                        >
                            {/* <DialogTitle id="confirm-save-title">
                                {`This will verify Aadhaar without checking your registered mobile number with Aadhaar linked number. Continue?`}
                            </DialogTitle> */}
                            <DialogContent>
                            ...
                            <DialogActions>
                                ...
                                <Button
                                    onClick={handleConfirmFetchAadhaar} // Calls function on Yes click
                                    variant="contained"
                                    color="primary"
                                    autoFocus
                                    sx={submitBtnStyle}
