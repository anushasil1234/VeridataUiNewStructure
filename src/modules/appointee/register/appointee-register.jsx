...
const AppointeeRegister = () => {
  ...
  console.log("isTrustEpfoAvailable", isTrustEpfoAvailable)
  ...
  //console.log("isAppointeeUanAvailable", isAppointeeUanAvailable)
  ...
  useEffect(() => {
    if (hasValue(isAppointeeUanAvailable)) {
      ...
      // setCurrentPageNo(3) // Disable the below section
      // setShowAdditionalSection(true);
      //setActiveStep(currentPageNo);
      // Enable additional section
    }
    //  else {
    //   setIsPreviousSectionDisabled(false); // Enable the below section
    //   setShowAdditionalSection(false); // Hide additional section initially
    // }
  ...
  //   // Call the saveDetails function when user confirms
  //   await saveDetails();
  ...
  // const handleGetUANNumber = async (isUANAvailable) => {
  //   const payLoad = {
  //     aaddharNumber: hasValue(aadhar) ? removeExtraSpaces(aadhar) : null,
  //     appointeeId,
  //     //aaddharName: hasValue(nameAsOnAadhar) ? removeExtraSpaces(nameAsOnAadhar) : null,
  ...
  //   const response = await getUANNumber(payLoad);
  //   if (response) {
  //     const { isUanAvailable, uanNumber, remarks,IsVarified } = response.responseInfo;
  //     if (isUanAvailable) {
  //       setUAN(uanNumber);
  //       setEpfoButton("Employement Verification");
  //       epfostatusMessage.message = "Fetched";
  ...
  //       openOtpForm(uanNumber, "UAN Number", () => validateUANOtp(uanNumber), 'Generate OTP for PF Verification');
  //     } 
  //     else if ((isUANAvailable === false) && (!isUanAvailable) && (!hasValue(uanNumber))) {
  ...
  //console.log("isUANAvailable",isUANAvailable)
  ...
  //console.log("isPreviousSectionDisabled", isPreviousSectionDisabled)
