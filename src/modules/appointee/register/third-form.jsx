import { Box, Button, Checkbox, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Divider, Fab, FormControl, FormControlLabel, Grid, IconButton, Radio, RadioGroup, Stack, Switch, Tooltip, Typography } from '@mui/material'
import React from 'react'
import FormHeadingContainer from 'shared/components/grid-container/form-heading-container'
import FormHeading from './form-heading'
import GridRow from 'shared/components/grid-container/grid-row'
import { checkBoxLabelStyle, checkBoxStyle, divederStyle, fileUploadSectionContainerStyle, headingType1, lable1CopyStyle, positionRelative, primaryFabStyle, statusBoxstyle, statusstyle, submitBtnContainerStyle, submitBtnStyle, verificationBtnStyle } from 'app'
import { Autorenew, HelpOutline, Info, InfoOutlined } from '@mui/icons-material'
import { aadharFileTypeAlias, epfoPassbookFileTypeAlias, epfoServiceHistoryFileTypeAlias, getHandicapTypeDescription, handicapFileTypeAlias, imgAndPdfMaxSize, otherFileTypeAlias, passportFileTypeAlias, previousButton, tenthCertificateFileTypeAlias, trustEpfoFileTypeAlias } from 'shared/constants/constants'
...
const ThirdForm = ({
    formElement, stepsList, isAadhaarVarified, isOfflineXmlDownloaded, setIsOfflineXmlDownloaded, handleIsOfflineXmlDownloadedOnChange,
    nameAsOnAadhar, handleChangeNameOnAadhar, aadharShareCode, setAadharShareCode, disabledAadharInput, isAadhaarXmlUploaded,
    handleAadharVerifiaction, aadharstatusMessage, uploadAadharXmlFile, aadharXmlFileName, pan, handelPANNumberChange, disabledPanInput,
    panNumberError, isPanVarified, handlePanVerifiaction, isPANModalOpen, handleDialogCancel, handleDialogConfirm, panstatusMessage,
    nameAsOnPan, isEpfoSectionDisabled, setUAN, UAN, isUanVarified, handleEpfoButtonClick, isUanVerificationProcessManual, epfoButton,
    epfostatusMessage, uanAadharLink, handleChangeUanVerification, uploadEpfoServiceHistoryFile, epfoServiceHistoryFile, uploadEpfoPassBookFile,
    removeEPFOPassbookFile, epfoPassBookFiles, handleBack, submitDetails
}) => {
