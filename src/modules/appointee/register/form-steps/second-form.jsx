                ...
                <Grid sx={{ paddingLeft: '0px !important' }} item xs={12} md={6}>
                  ...
                  {firstPageForm.originCountry === 'India' && (
                    <>
                      ...
                      <VerificationStatusSection docType={passportstatusMessage} />
                    </>
                  )}
                </Grid>
                <Grid
                ...
                <Box>
                  ...
                  <FormControl sx={{ marginLeft: '17px' }}>
                    ...
                    >
                      ...
                      <Switch
                        onChange={({ target }) => setIsTrustEpfoAvailable(target.checked)}
          ...
          <GridRow>
            <Grid sx={{ paddingLeft: '0px !important' }} item xs={12} md={6}>
              <Stack flexDirection={'col'} justifyContent={'space-between'} alignItems={'start'}>
                <Typography sx={{ ...lable1CopyStyle }}>{t('Do you have UAN number')}</Typography>
                <RadioGroup
                  row
