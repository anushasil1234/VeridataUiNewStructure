...
//             {closeModel && (
//               <IconButton edge='start' color='inherit' onClick={closeModel} aria-label='close'>
//                 <Close />
//               </IconButton>
//             )}
//             {headerText && (
//               <Typography
//                 sx={{ ...fileNameStyleinview, ml: '5px', fontWeight: 600, fontSize: '1.27rem' }}
//               >
//                 {headerText}
//               </Typography>
//             )}
...
//         <ListItem sx={fullScreenListItemStyle}>{content}</ListItem>
//       </List>
//     </Dialog>
//   );
// }
