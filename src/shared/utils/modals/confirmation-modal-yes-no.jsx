...
const ConfirmationYesNoModal = ({ open, confirmationYesNoModelContent, handleClose }) => {
  const { dialogTitle, dialogComponent, dialogContentText, confirmedYes, confirmedNo, firstButtonName = "Yes", secondButtonName = "No", fullWidth = false, maxWidth = 'sm' , disableCloseIcon = false} = confirmationYesNoModelContent || "";
