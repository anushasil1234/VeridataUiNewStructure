...
const UploadType_Update = `UPDATE`;
const Users = `/Users`;
...
export const DownloadUpdateSampleXlsFile_URL = `${FileUpload}/DownloadSampleXlsFile?type=${UploadType_Update}`;
...
export const GetCurrentPolicyDetails_URL = `${Masters}/GetCurrentWorkflowPolicy`;
export const PostNewPolicyDetails_URL = `${Masters}/CreateNewtWorkflowPolicy`;
...
export const AppointeeProfileImageUpdate_URL = `${Candidate}/AppointeeProfileImageUpdate`;
...
export const passportFilePatternErrorMsg = 'Passport File Number must be of 20 digits';
...
export const toPolicySetup = '/policysetup';
