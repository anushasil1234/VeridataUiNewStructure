...
let AppStyle = createTheme({
  ...
  typography: {
    fontFamily: ["Montserrat", "Anuphan"].join(","),
...
export const fontSizeType1 = {
  fontSize: { xs: ".75rem!important", md: "1rem!important" },
};
...
export const highlighting = {
  fontWeight: "bold",
  // color: "yellow",
  backgroundColor: "rgb(154 32 140 / 18%)",
  padding: "2px 4px",
  borderRadius: "4px",
};
// heading ends
...
export const useFileChipStyles = () => {
  return (fileOption, viewedFiles) => ({
    cursor: "pointer",
    backgroundColor: viewedFiles.some(
      (file) => file.fileName === fileOption.fileName
    )
      ? ThemeColorPalete.primary.dark
      : ThemeColorPalete.grey.light,
    color: "white",
    border: "1px solid",
    borderColor: viewedFiles.some(
      (file) => file.fileName === fileOption.fileName
    )
      ? ThemeColorPalete.primary.dark
      : ThemeColorPalete.grey.light,
...
export const loaderStyle = {
  ...
  width: "16.35vw",
  borderRadius: "50%",
  borderTop: "5px solid transparent", // Add a transparent border for animation
